...
This blog post is an example for such a document. The page is written in **markdown** (click the link in the sidebar for the source file), and all embedded code was executed when this page was generated, i.e. when the markdown was converted to HTML and the blog post was published. To demonstrate this I have embedded code in three different languages below - the output is the second code block.
